...
inputPanel(
  selectInput("v_galaxy", label = "Galaxy Velocity:", 
              choices = c("0 km/s" = 0, "60 km/s" = 60, "125 km/s" = 125), ),
  
  selectInput("v_outflow", label = "Outflow Velocity:", 
              choices = c("100 km/s" = 100, "200 km/s" = 200), ),
...
renderPlot({
  ...
  ggplot(spectrum_sub, aes(x=x,y=y)) + geom_line(col = 30, lw = 2) + labs(title=text, x="Velocity (km/s)", y="Intensity (Arbitrary Units)") + xlim(-1000, 4010) + ylim(0, 6500) + theme(plot.title = element_text(hjust = 1, vjust = 1))
