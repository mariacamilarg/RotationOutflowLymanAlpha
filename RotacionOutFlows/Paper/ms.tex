...
\keywords{Lyman Alpha Emission, Galaxy Rotation, Galaxy Outflows ....MISSING....} 
...
We have then 3 parameters left that are going to vary along a wide range. These are: the galaxy viewing angle \ang, the hydrogen column density \nh and the outflow expanding velocity \vel. \\

\ang covers 3 different angles: $0^\circ$, $45^\circ$ and $90^\circ$. \lognh takes 41 different values from 20.0 to 22.5. And \vel covers 5 equidistant velocities from 100 \kms to 500 \kms. The permutations of these three are analyzed in section \ref{sec:results}.
...
\end{center}
\caption{\textbf{Influence of Outflow Expanding Velocity:} The values of the fixed parameters are \lognh = 20.0625 and \ang = 90$^\circ$. MISSIIIIIIING.\\
